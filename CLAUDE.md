...
- Error displays in popup: "Timer is already running in another tab" (localized in 20 languages: en, zh_TW, zh_CN, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el)
