...
- **Slovenian language support** (`sl` locale)
  ...
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el, cs, hu, ro, bg, uk, sk, hr, sr, sl (29 total)
...
- **Serbian language support** (`sr` locale)
  ...
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el, cs, hu, ro, bg, uk, sk, hr, sr (28 total)
...
### Added
- **Slovak language support** (`sk` locale)
  - All 34 message keys translated to Slovak
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el, cs, hu, ro, bg, uk, sk (26 total)
...
### Added
- **Bulgarian language support** (`bg` locale)
  - All 34 message keys translated to Bulgarian
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el, cs, hu, ro, bg (24 total)
...
### Added
- **Hungarian language support** (`hu` locale)
  - All 34 message keys translated to Hungarian
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el, cs, hu (22 total)

## [1.1.17] - 2026-01-07

### Added
- **Czech language support** (`cs` locale)
  - All 34 message keys translated to Czech
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el, cs (21 total)

## [1.1.16] - 2026-01-07

### Added
- **Greek language support** (`el` locale)
  - All 34 message keys translated to Greek
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi, el (20 total)

## [1.1.15] - 2026-01-07

### Added
- **Finnish language support** (`fi` locale)
  - All 34 message keys translated to Finnish
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no, fi (19 total)

## [1.1.14] - 2026-01-07

### Added
- **Norwegian language support** (`no` locale)
  - All 34 message keys translated to Norwegian
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da, no (18 total)

## [1.1.13] - 2026-01-07

### Added
- **Danish language support** (`da` locale)
  - All 34 message keys translated to Danish
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv, da (17 total)

## [1.1.12] - 2026-01-07

### Added
- **Swedish language support** (`sv` locale)
  - All 34 message keys translated to Swedish
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr, sv (16 total)

## [1.1.11] - 2026-01-07

### Added
- **Turkish language support** (`tr` locale)
  - All 34 message keys translated to Turkish
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl, tr (15 total)

## [1.1.10] - 2026-01-07

### Added
- **Polish language support** (`pl` locale)
  - All 34 message keys translated to Polish
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl, pl (14 total)

## [1.1.9] - 2026-01-07

### Added
- **Dutch language support** (`nl` locale)
  - All 34 message keys translated to Dutch
  - Supported languages now: zh_TW, zh_CN, en, ja, ko, ar, ru, es, fr, de, pt, it, nl (13 total)
